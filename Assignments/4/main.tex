...
\begin{enumerate}[itemsep=0pt,topsep=0pt,label=\alph*)]
  ...
  \end{align*}
  \item In this case, the total distance is the sum of the air thickness and the reduced thickness:
  \begin{align*}
...
\section*{Exercise 2}
I will assume that the glass rod is intended to perform the action of the two lenses in each case so that depending on the raddi of durvatures of each surface,
an incoming collimated ray will outputs collimated by scaled. Therefore, the problem reduces to find $R_1$ and $R_2$ of the rod to accomplish both 
conditions: remains collimated, and perform magnification.
\begin{enumerate}[itemsep=0pt,topsep=0pt,label=\alph*)]
  \item For a magnification of $-0.5$, we want to only scale the height but to have a net zero power of the optical system, which means that 
  \begin{align*}
    \Phi_{\text{total}}=\Phi_{1}+\Phi_{2}-\frac{t}{n}\Phi_1\Phi_2=0.
  \end{align*}
  Using the magnification formula for afocal systems $m=-f_2/f_1$ and the definition of the optical power $\Phi_i=(n'-n)/R_i$  allow us to related 
  ...
  \begin{align*}
    \Phi_2=30\longrightarrow R_2=-0.016\;mm.
  \end{align*}
  Then, $R_1$ is 
  \begin{align*}
    \Phi_1=0.5(30)=15\longrightarrow R_1=0.033\;mm.
  \end{align*}
  ...
  \begin{align*}
    \Phi_1=5\longrightarrow R_1=0.10\;mm.
  \end{align*}
  The same for $R_2$ is 
  \begin{align*}
    \Phi_2=-2(5)=-10\longrightarrow R_2=0.050\;mm.
  \end{align*}
\end{enumerate}
