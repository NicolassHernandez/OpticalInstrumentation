...
\begin{enumerate}[itemsep=0pt,topsep=0pt,label=\alph*)]
  ...
  \begin{align*}
    f/\#=\frac{f_E}{D_{EP}}\longrightarrow D^{\text{new}}_{EP}=10.87\;mm.
  \end{align*}
  With this value, we can obtain the scale we need to apply to the exit pupil and the stop diameters:
  \begin{align*}
    m=\frac{D_{EP}^{\text{new}}}{D_{EP}^{\text{old}}}=\frac{10.87}{16.39}=0.663.
  \end{align*}
  Therefore,
  \begin{align*}
    D_{\text{stop}}^{\text{new}}=mD_{\text{stop}}^{\text{old}}=6.63\;mm,\quad\text{and}\quad D_{XP}^{\text{new}}=mD_{XP}^{\text{old}}=7.79\;mm.
  \end{align*}
\end{enumerate}
