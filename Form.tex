...
\begin{table}[h!]
    ...
    \begin{tabular}{l|l|l}
        ...
        \multicolumn{3}{l}{Afocal systems $m=-f_2/f_1$}\\
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=.3\columnwidth]{figures/snell.png}
    \includegraphics[width=.3\columnwidth]{figures/imagerotations.png}
    \includegraphics[width=.7\columnwidth]{figures/paraxialgeometry.png}
\end{figure}
\end{paracol}
...
\begin{itemize}[itemsep=0pt,topsep=0pt]
    ...
    \item In negative lenses, the rear and focal points are reversed from positive lenses.
