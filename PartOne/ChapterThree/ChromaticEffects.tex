...
\begin{align}
    \text{Transverse axial chromatic aberration (10)}\qquad\highlight{\text{TA}_{CH}=\frac{r_P}{\nu}}.
\end{align}
\begin{figure}[h!]
    \centering
    \begin{subfigure}{.6\columnwidth}
...
All we have done is to force the axial focus for F and C light. However, the d line can focus at a different location. 
This is known as \bfemph{secondary chromatic aberration}.
%
\subsection{Secondary chromatic aberration}
We have ensured the F and C lines are at the same longitudinal distance, but the d line havea different focal position.
\begin{figure}[h!]
    \centering
    \includegraphics[width=.4\columnwidth]{PartOne/ChapterThree/figures/secondarychromaticaberration.png}
