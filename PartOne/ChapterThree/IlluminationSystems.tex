...
\begin{figure}[h!]
    \centering
    \includegraphics[width=.7\columnwidth]{PartOne/ChapterThree/figures/projectorcondensersyste.png}
...
\begin{itemize}[itemsep=0pt,topsep=0pt]
    \item The condenser lens serves as a field lens, bending the chief ray of the iamging system back into the projection lens.
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=.7\columnwidth]{PartOne/ChapterThree/figures/nocollectionlens.png}
...
there is a condenser lens. However, the inclusion of a \bfemph{diffuser} makes that all angles are presents due to scattering; the source no appears to be large.
\begin{figure}[h!]
    \centering
    \begin{subfigure}{.45\columnwidth}
        \centering
        \includegraphics[width=\columnwidth]{PartOne/ChapterThree/figures/baresource.png}
        \caption{Bare source}
    \end{subfigure}
    \hfill
    \begin{subfigure}{.45\columnwidth}
        \centering
        \includegraphics[width=\columnwidth]{PartOne/ChapterThree/figures/diffuser.png}
...
\begin{itemize}[itemsep=0pt,topsep=0pt]
    \item\textbf{What drives the choise in projection lens?}\\We image the transparent object. How big is the screen? Where is it? What kind of magnification do we need?
    ...
    \item\textbf{Must be the projection lens diameter be larger than the source image size?}\\Yes, thisdetermines the $f/\#$ of the projection lens.
\end{itemize}
%
...
The source produces an intermediate image at the substage diaphragm, and an image at the objective. Similarly, the object is at the field diaphargm and generates an 
intermediate image after the substage condenser.  
The \bfemph{subtage diaphragm} (at source image) allows the overall light level to be varied, and the \bfemph{field diaphragm} (at object image) changes the amount of the object that is illuminated.
%
