...
\bfemph{Thin prisms} introduce small angular beam deviations $\delta$ that is approximately independent of the incident angle:
\begin{align}
...
\begin{align}
    ...
    \end{array}.
\end{align}
In order to get sufficient dispersion, it is often necessary to use more than two prisms.
%
