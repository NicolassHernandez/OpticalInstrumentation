...
The Keplearian has a negative MP $\text{MP}<1$ and the image presented to the eye is inverted and reverted (rotated $189^\circ$). The eye should be placed at the real XP to couple the eye to the telescope and see the entire FOV, if not vignetting may occur.
The XP position is called the \bfemph{eye relief} ER.  The magnification of the telescope related the diameters of EP and XP:
\begin{align}
...
This combination is called an \bfemph{eyepiece}. If we assume the separation between them si equal to the focal length of the eye lens, then the overall power is:
\begin{align*}
...
An \bfemph{eyepiece} or \bfemph{ocular} is the combination of the field lens and the eye lens. A simple eye piece does not have a field lens. A compounf eyepiece has both of them.
