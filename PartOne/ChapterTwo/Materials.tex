...
Over the visible spectrum, the \bfemph{dispersion} of the index for optical glass is about $0.5\%$ (low dispersion) to $1.5\%$ (high dispersion) of the mean value of the index.
\begin{figure}[h!]
    \centering
...
The addition of lead oxide increases the dispersion and the index and moves the glass up the glass line. To increase the index without changing the dispersion, barium oxide is added.
