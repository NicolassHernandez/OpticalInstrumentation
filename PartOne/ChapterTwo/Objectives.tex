...
\begin{emphasizer}
    \begin{itemize}[itemsep=0pt,topsep=0pt]
        \item Focusing at the hyperfocal distance \textbf{ensures} that any greater distance that $L_{\text{near}}=L_H/2$ meets the blur criteria.
...
\begin{example}{Digital camera}
    ...
    \begin{enumerate}[itemsep=0pt,topsep=0pt,label=\alph*)]
        \item CCD pixel pitch chosen is $4\;\mu m$. And camera at $L_H=20\;m$ away from the house.
        \item The hyperfocal distance is $L_H=20\;mm$. The blur is $B'\approx4\;\mu m$.
        
        We also fit the diameter of Airy in the pixel size with the average wavelength $\lambda=550\;nm$ to reach the diffraction-limited condition:
        \begin{align*}
            2.44\lambda f/\#=B'\longrightarrow f/\#=\frac{4}{2.44\cdot0.5}=2.981\approx 4.
        \end{align*}
        \item The hyperfocal distance can be related to focal length:
        \begin{align*}
        ...
        \end{align*}
        We can think of the thin lens taking an object at $-20\;m$ and imaging at $L_H'$ (approximately):
        \begin{align*}
            \frac{1}{L_H'}=\frac{1}{L_H}+\frac{1}{f}
        \end{align*}
        \begin{figure}[h!]
            \centering
            \includegraphics[width=.6\columnwidth]{PartOne/ChapterTwo/ex_obj.png}
        \end{figure}


        But $L_H'=f+\text{DOF}\approx f$ so that the magnification is:
        \begin{align*}
            m=\frac{L_H'}{L_H}=\frac{\approx18\;mm}{-20\;m}\approx-1\cdot10^{-3}.
        \end{align*}
        The field of view for each dimension in image space is the traingle formed by $L_H'$ and the size of 
        one pixel detector:
        \begin{align*}
            \text{HFOV}_H&=\tan^{-1}\frac{7.02}{18\;mm}=\pm1.568^\circ\\
            \text{HFOV}_W&=\tan^{-1}\frac{12.48}{18\;mm}=\pm1.569^\circ.
        \end{align*}
