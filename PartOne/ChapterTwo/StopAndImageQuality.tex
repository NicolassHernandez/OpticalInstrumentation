...
For a singlet, the power of the lens increases quadratically with pupil radius; the focal length decrease quadratically.
...
At finite conjugates, a biconvex lens is used. A trick to further minimize spherical aberration in finite conjugates is to split the biconvex into two plano-convex lenses and then flip each of the lenses.

With large apertures, aberrations and depth of field errors are dominant. With small apertures, diffraction dominates with a linear dependence of blur with $f/\#$.
