...
to left, so the respective minus sign must be added (as in reflection).
\begin{figure}[h!]
    \centering
...
For EP, remember that the direction of propagation is \textbf{oposite} to the classical, so we flip the sign of distances and refractive indices.
