...
\begin{example}{Raytrace of chief and marginal rays}
    The following diagram illustrate the trace by hand of the chief and marginal ray by definition.
    \begin{figure}[h!]
        \centering
        \includegraphics[width=.25\columnwidth, angle=-90]{PartOne/ChapterTwo/crmr.png}
    \end{figure}
\end{example}
%%
...
\begin{align}
    \text{Image/Object}&\qquad y=0,\quad\Xi=-nu\bar{y}=-\omega\bar{y}\\
    \text{Pupils}&\qquad\bar{y}=0,\quad\Xi=n\bar{u}y=\bar{\omega}y
\end{align}
